    ...
    "http://1337.abcvg.info:80/announce"
            ...
            foreach (var trackerUrl in httpTrackers)
            {
                ...
                try
                {
                    ...
                    var successHandshake = false;
                    var peerClient = new PeerClient(meta.InfoHash, peerId);
                    foreach (var peer in peers)
                    {
                        var success = await peerClient.PerformHandshakeAsync(peer);
